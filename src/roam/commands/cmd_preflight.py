...
Combines blast radius, affected tests, complexity, and coupling into a
single call -- reducing round-trips for AI agents from 4-5 calls to 1.
"""
...
def preflight(ctx, target, staged):
    ...
    Combines blast radius, affected tests, complexity, and coupling checks
    into a single report. Ideal for AI agents that want one-call risk
